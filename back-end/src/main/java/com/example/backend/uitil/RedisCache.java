...
public class RedisCache {
    ...
    public <T> long setCacheList(final String key, final List<T> dataList) {
        final Long count = redisTemplate.opsForList().rightPushAll(key, dataList);
    ...
    Set<T> dataSet) {
        final BoundSetOperations<String, T> setOperation =
    ...
    public <T> T getCacheMapValue(final String key, final String hKey) {
        final HashOperations<String, String, T> opsForHash =
